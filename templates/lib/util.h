...
*/
GRANTLEE_TEMPLATES_EXPORT Grantlee::SafeString markSafe( const Grantlee::SafeString &input );

/**
  Marks the @p input as requiring escaping.
*/
GRANTLEE_TEMPLATES_EXPORT Grantlee::SafeString markForEscaping( const Grantlee::SafeString &input );

/**
  Retrieves and returns a SafeString from the @p input.
*/
GRANTLEE_TEMPLATES_EXPORT Grantlee::SafeString getSafeString( const QVariant &input );
